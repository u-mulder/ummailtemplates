...
`#FOR_LOOP_START_ZZZ#` и `#FOR_LOOP_END_ZZZ#` распознаана не будет.
...
Внимание: мной проверялись только простейшая разметка Twig с циклом for. Все остальные варианты разметок **не проверялись**.
